...
f	6	6. Циклические алгоритмы для Исполнителя	1	1	f
...
f	22	22. Многопоточные вычисления	1	1	f
...
f	26	26. Обработка данных с помощью сортировки	3	2	f
f	27	27. Обработка потока данных	3	2	f
t	103	103. Поиск и сортировка в базах данных	1	1	f
t	106	106. Анализ программ с циклами	1	1	f
t	109	109. Обработка числовой информации в электронных таблицах	1	1	f
t	117	117. Обработка целочисленных данных. Проверка делимости	1	1	f
t	122	122. Анализ программ с циклами и ветвлениями	1	1	f
\.
