...
extern "C" __cxa_type_match_result __cxa_type_match(_Unwind_Exception*, std::type_info const*, bool,
                                                    void**);
...
extern void __unexpected(std::terminate_handler) __attribute__((__noreturn__));
...
static inline __cxa_dependent_exception* __get_dependent_exception_from_ue(_Unwind_Exception* exc) {
