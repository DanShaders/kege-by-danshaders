...
namespace detail {
	 ...
	 *
	 * @ref async::detail::promise_type_facade::unhandled_exception (call generated by compiler) ->
	 * @ref async::event_loop::handle_exception (virtual) -> @ref
	 ...
	 *
	 * @relates on_unhandled_exception_cb
	 */
