...
async function showUsersPage(params: URLSearchParams): Promise<void> {
	requireAuth(1);
	...
	const [csvInput] = (
		<>
			...
			Колонки: логин, пароль, имя, группы. Например: <pre>danklishch,password?,"Клищ Данил Павлович",Долгопрудный,12-ая параллель{"\n"}
mlxa,"qwerty,","""Будников"" Михаил Сергеевич",Бремен</pre>
			<b>Это удаляет текущих пользователей, включая информацию об их ответах!</b> (кроме admin и user)<br />
			...
			<a href="/api/users/html-list" target="_blank">Текущий список пользователей</a>
		</>
